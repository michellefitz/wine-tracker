...
import { getGrapeProfile, prettifyKey, profileKeys, winesWithGrape } from "@/lib/grapes";
import { withFoundGrapes } from "@/lib/wine-facts";
import { listWines } from "@/lib/wines";
import type { Wine } from "@/lib/types";

/**
 * A profile that isn't cached yet takes a few seconds to write, so the shell
 * and this outline stream first. It mirrors the real layout rather than
...
/**
 * One grape, rendered the same whether it arrived as a page or as a sheet.
 *
 * A grape has nothing to edit, so in a sheet it carries no navigation at all —
